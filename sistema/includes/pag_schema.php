...
function pag_schema_seed_fixed_pages()
{
    ...
    $permissions = [
        ...
        ['codigo' => 'roles.toggle_state', 'nombre' => 'Cambiar estado roles', 'descripcion' => 'Permite activar o inactivar roles.'],
        ['codigo' => 'roles.delete', 'nombre' => 'Eliminar roles', 'descripcion' => 'Permiso legado no usado en V1 de Roles.'],
        ['codigo' => 'permisos.view', 'nombre' => 'Ver permisos', 'descripcion' => 'Permite ver listado de permisos.'],
        ['codigo' => 'permisos.assign', 'nombre' => 'Asignar permisos', 'descripcion' => 'Permite asignar y desasignar permisos por rol.'],
        ['codigo' => 'permisos.create', 'nombre' => 'Crear permisos', 'descripcion' => 'Permiso legado no usado en V1 de Permisos.'],
        ['codigo' => 'permisos.edit', 'nombre' => 'Editar permisos', 'descripcion' => 'Permiso legado no usado en V1 de Permisos.'],
        ['codigo' => 'permisos.delete', 'nombre' => 'Eliminar permisos', 'descripcion' => 'Permiso legado no usado en V1 de Permisos.'],
